...
fire_sound_1.set_volume(0.15)
fire_sound_2 = Load_Sound_From_Zip('sounds/fire2.wav')
fire_sound_2.set_volume(0.15)
...
rotate_sound.set_volume(0.07)
forward_sound = Load_Sound_From_Zip("sounds/forward.wav")
forward_sound.set_volume(0.15)
...
def Button(msg,x,y,ac,ic,action=None,func=None):
    ...
    smallText = Load_Font_From_Zip('fonts/Games.ttf', int(SCREEN_HEIGHT / 38.4))
